        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ul class="list-group mt-3" id="searchList">
                    ...
                    <li class="list-group-item" onclick="selectCustomer('All', '')" data-value="all">All</li>
                    <?php
                    $sql = mysqli_query($koneksi, "SELECT * FROM user WHERE status != 'pickup' ORDER BY login_id ASC") or die(mysqli_error($koneksi));
...
<script>
    ...
    function selectCustomer(customer, userId) {
        // Jika customer adalah 'All', kosongkan input user_id, artinya semua data akan diambil
        if (userId === '') {
            document.getElementById('user_id').value = 'All'; // Kosongkan jika pilih "All"
        } else {
            document.getElementById('user_id').value = customer; // Set ke login_id user yang dipilih
        }
